    ...
    <div class="col-md-12">
      <div class="card card-block headerCard">
        <div class="row">
          ...
          <span class="col-md-4 pageHeading"><?php echo '&nbsp;' . $CLICSHOPPING_Categories->getDef('heading_title'); ?></span>
...
?>
  <form name="CatalogCategoriesConfigure" action="<?php echo $CLICSHOPPING_Categories->link('Configure&Process&module=' . $current_module); ?>" method="post">
...
?>
     <div class="col-md-12 mainTitle"><strong><?php echo $CLICSHOPPING_Categories->getConfigModuleInfo($current_module, 'title'); ?></strong></div>
     <div class="adminformTitle">
       <div class="row">
         <div class="separator"></div>
          <div class="col-md-12">
