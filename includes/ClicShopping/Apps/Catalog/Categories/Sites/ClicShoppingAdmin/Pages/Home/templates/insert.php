...
?>
    ...
    <div id="categoriesTabs" style="overflow: auto;">
      <ul class="nav nav-tabs flex-column flex-sm-row" role="tablist"  id="myTab">
        ...
        <li class="nav-item"><?php echo '<a href="#tab2" role="tab" data-toggle="tab" class="nav-link">' .  $CLICSHOPPING_Categories->getDef('tab_description') . '</a>'; ?></li>
        <li class="nav-item"><?php echo '<a href="#tab3" role="tab" data-toggle="tab" class="nav-link">' .  $CLICSHOPPING_Categories->getDef('tab_ref') . '</a>'; ?></li>
        <li class="nav-item"><?php echo '<a href="#tab4" role="tab" data-toggle="tab" class="nav-link">' .  $CLICSHOPPING_Categories->getDef('tab_img') . '</a>'; ?></li>
      </ul>
              ...
              <div class="row">
                <span class="col-md-12">
                 <?php echo $CLICSHOPPING_Categories->getDef('help_options'); ?>
                  <blockquote><i><a data-toggle="modal" data-target="#myModalWysiwyg2"><?php echo $CLICSHOPPING_Categories->getDef('text_help_wysiwyg'); ?></a></i></blockquote>
                   ...
                   <div class="modal-dialog">
                     <div class="modal-content">
                       <div class="modal-header">
                         ...
                         <h4 class="modal-title" id="myModalLabel"><?php echo $CLICSHOPPING_Categories->getDef('text_help_wysiwyg'); ?></h4>
                       </div>
            ...
            <div class="adminformTitle">
              ...
              <div class="row">
                <div class="col-md-12 text-md-center">
                  ...
                  <span class="col-md-3"><a href="https://www.google.fr/trends" target="_blank" rel="noreferrer"><?php echo $CLICSHOPPING_Categories->getDef('keywords_google_trend'); ?></a></span>
                  <span class="col-md-3"><a href="https://adwords.google.com/select/KeywordToolExternal" target="_blank" rel="noreferrer"><?php echo $CLICSHOPPING_Categories->getDef('analysis_google_tool'); ?></a></span>
                </div>
              </div>
<?php
  for ($i=0, $n=count($languages); $i<$n; $i++) {
...
?>
          <div class="tab-pane" id="tab4">
            ...
            <div class="adminformTitle">
              <div class="row">
                <div class="col-md-12">
                  <span class="col-md-1"><?php echo HTML::image($CLICSHOPPING_Template->getImageDirectory() . '/categories/banner_manager.gif', $CLICSHOPPING_Categories->getDef('text_categories_image_vignette'), '40', '40'); ?></span>
                  <span class="col-md-3 main"><?php echo $CLICSHOPPING_Categories->getDef('text_categories_image_vignette'); ?></span>
                  <span class="col-md-1"><?php echo HTML::image($CLICSHOPPING_Template->getImageDirectory() . '/images_categories.gif', $CLICSHOPPING_Categories->getDef('text_categories_image_visuel'), '40', '40'); ?></span>
                  <span class="col-md-7 main"><?php echo $CLICSHOPPING_Categories->getDef('text_categories_image_visuel'); ?></span>
                </div>
                <div class="col-md-12">
