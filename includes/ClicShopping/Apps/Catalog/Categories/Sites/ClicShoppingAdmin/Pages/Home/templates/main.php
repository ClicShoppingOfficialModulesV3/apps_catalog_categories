...
?>
  <div class="contentBody">
    ...
    <div class="col-md-12 mainTitle"><strong><?php echo $CLICSHOPPING_Categories->getDef('text_products_categories') ; ?></strong></div>
...
<?php
  echo HTML::form('configure', CLICSHOPPING::link('index.php', 'A&Catalog\Categories&Configure'));
