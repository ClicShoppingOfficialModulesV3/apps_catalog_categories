...
?>
  <div class="contentBody">
    ...
    <div class="col-md-12 mainTitle"><strong><?php echo $CLICSHOPPING_Categories->getDef('text_info_heading_delete_category'); ?></strong></div>
    ...
    <div class="adminformTitle">
      <div class="row">
        <div class="separator"></div>
        <div class="col-md-12"><?php echo $CLICSHOPPING_Categories->getDef('text_delete_category_intro'); ?><br/><br/></div>
        <div class="separator"></div>
        <div class="col-md-12">
...
?>
            <div class="separator"></div>
            <div class="col-md-12">
              <span class="col-md-12"><?php echo $CLICSHOPPING_Categories->getDef('text_delete_warning_childs', ['delete_child' => $cInfo->childs_count]); ?></span>
            </div>
<?php
  }
...
?>
            <div class="separator"></div>
            <div class="col-md-12">
              <span class="col-md-12"><?php echo $CLICSHOPPING_Categories->getDef('text_delete_warning_products', ['delete_warning' => $cInfo->products_count]); ?></span>
            </div>
<?php
          }
?>
